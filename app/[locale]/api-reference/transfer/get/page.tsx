...
export default function GetTransferPage() {
  return (
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-slate dark:prose-invert max-w-none">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h1 className="text-3xl font-bold my-0">Get Transfer</h1>
                </div>

                <code className="text-base">/v1/transfers/:transfer_id</code>

                <p className="text-lg text-muted-foreground mt-4">
                  {"Get transfer status and details including current status, amount, fees, and timestamps."}
                </p>
                  ...
                  <table className="min-w-full">
                    ...
                    <tbody className="text-sm">
                      <tr className="border-b border-border">
                        ...
                        <td className="py-2 px-4">Yes</td>
                        <td className="py-2 px-4">{"Unique identifier of the transfer"}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
  ...
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN"`,
                    ...
                    {
                      language: "Node.js",
                      code: `const response = await fetch('https://api.ricash.com/v1/transfers/transfer_xyz789', {
  method: 'GET',
  headers: {
...
response = requests.get(
    'https://api.ricash.com/v1/transfers/transfer_xyz789',
    headers={
        'Authorization': 'Bearer YOUR_ACCESS_TOKEN'
    }
)
...
print(transfer)`,
  ...
  "updated_at": "2025-01-15T10:35:00Z"
                ...
                <h3 className="text-xl font-semibold mt-6 mb-3">Transfer Statuses</h3>
                <ul className="list-disc pl-6 space-y-2">
                  <li><code>pending</code> - {"Transfer has been created and is being processed"}</li>
                  <li><code>processing</code> - {"Transfer is being executed"}</li>
                  <li><code>completed</code> - {"Transfer was successful"}</li>
                  <li><code>failed</code> - {"Transfer failed (see error details)"}</li>
                  <li><code>cancelled</code> - {"Transfer was cancelled"}</li>
                </ul>
