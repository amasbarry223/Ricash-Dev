            ...
            <div className="max-w-4xl mx-auto">
              ...
              <div className="prose prose-slate dark:prose-invert max-w-none">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h1 className="text-3xl font-bold my-0">Get Agent Commissions</h1>
                </div>

                <code className="text-base">/v1/agents/:agent_id/commissions</code>

                <p className="text-lg text-muted-foreground mt-4">
                  {"Get commission history for an agent. Includes all transactions and commission earnings."}
                </p>
                  ...
                  <table className="min-w-full">
                    ...
                    <tbody className="text-sm">
                      <tr className="border-b border-border">
                        ...
                        <td className="py-2 px-4">{"Unique identifier of the agent"}</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
                ...
                <CodeTabs
                  examples={[
                    {
                      language: "cURL",
                      code: `curl -X GET "https://api.ricash.com/v1/agents/agent_abc123/commissions?from_date=2025-01-01&to_date=2025-01-31&page=1&limit=20" \\
  -H "Authorization: Bearer YOUR_ACCESS_TOKEN"`,
                    },
                    {
                      language: "Node.js",
                      code: `const response = await fetch('https://api.ricash.com/v1/agents/agent_abc123/commissions?from_date=2025-01-01&to_date=2025-01-31&page=1&limit=20', {
  method: 'GET',
  headers: {
  ...
  "pagination": {
    ...
    "total_pages": 1
                ...
                <ApiPlayground
                  ...
                  method="GET"
                  fields={[
                    { name: "agent_id", label: "Agent ID", type: "text", required: true, placeholder: "agent_abc123" },
